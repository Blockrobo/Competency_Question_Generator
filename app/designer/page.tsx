...
export default function Page() {
  ...
  /**
   * Sends lesson-design inputs to the legacy Flask backend and normalizes the response.
   * @param _sessionHistory Prior chat turns (currently unused by the legacy API).
   * @param refinementRequest Optional teacher refinement string appended to notes.
   * @returns A LessonDesign ready for the canvas, or null on failure.
   */
